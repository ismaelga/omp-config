---
name: wizard
description: "Generate an interactive bash wizard for steps only a human can do: infra provisioning, credentials, CI secrets, third-party dashboards, one-off cutovers."
---
