...
Rule set vendored from `vercel-labs/web-interface-guidelines` (MIT, see LICENSE).
Upstream ships this as a slash command that Vercel's own skill re-fetches from
GitHub on every single run. This is a pinned local copy: reviews stay
