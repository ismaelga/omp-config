---
name: brainstorming
description: "Use before creative work - new features, components, functionality, or behavior changes - to explore intent and design before implementation."
---
...
6. **Write design doc** — save to `.omo/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `.omo/specs/YYYY-MM-DD-<topic>-design.md`
