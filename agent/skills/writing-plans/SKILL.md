...
[What this plan deliberately does NOT do, one line each with the reason. Copied from
the spec's out-of-scope list, plus anything ruled out while planning. A reviewer or
implementer who wants to add one of these must change the plan first, not improvise.]
